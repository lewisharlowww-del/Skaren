...
export function scoreToGrade(score: number): GradeLetter {
  // Canonical band thresholds, identical to lib/healthscore.ts, history, stats
  // and the score card. Previously 81/61/41/21 here, which graded a score of
  // exactly 80 as B while the rest of the app called it A.
