...
function StatsSkeleton() {
  return (
    <div className="mt-6 space-y-3">
      <div className="h-24 animate-pulse rounded-[var(--sk-radius-lg)] bg-[var(--sk-surface-white)]" />
      <div className="grid grid-cols-2 gap-3">
        <div className="h-32 animate-pulse rounded-[var(--sk-radius-lg)] bg-[var(--sk-surface-white)]" />
        <div className="h-32 animate-pulse rounded-[var(--sk-radius-lg)] bg-[var(--sk-surface-white)]" />
      </div>
      <div className="h-32 animate-pulse rounded-[var(--sk-radius-lg)] bg-[var(--sk-surface-white)]" />
      <div className="h-44 animate-pulse rounded-[var(--sk-radius-lg)] bg-[var(--sk-surface-white)]" />
      <div className="h-24 animate-pulse rounded-[var(--sk-radius-lg)] bg-[var(--sk-surface-white)]" />
      <div className="h-52 animate-pulse rounded-[var(--sk-radius-lg)] bg-[var(--sk-surface-white)]" />
    </div>
  );
}
