...
/**
 * AppSplash — the cold-start launch splash (design 19A).
 *
 * ONLY used by app/loading.tsx for the initial app boot. Do NOT use this for
 * per-page/tab load states — those use <SkarenLoader/>, which is the quiet
 * paper-toned barcode loader. Throwing this full dark animation on every tab
 * switch is wrong; it is a launch moment, not a spinner.
 *
 * Merk assembles himself, reads his own barcode, then hands you the app: the
 * receipt body rises, the folded corner flips down with two sparks, the eyes
 * blink and dart, a smile appears, a green equalizer pulses in his belly and a
 * scan line sweeps him, then the SKAREN wordmark and tagline settle in.
 * Pure CSS keyframes (zero JS, paints first frame), ~1.9s intro that holds.
 */
export function AppSplash() {
  return (
    <div
      className="sk-splash-screen"
      style={{
        position: 'relative',
        height: '100dvh',
        width: '100%',
...
@media (prefers-reduced-motion: reduce) {
  .sk-splash-screen * { animation: none !important; opacity: 1 !important; transform: none !important; }
}
`
